...
public class Patient1MoveAndSpeakController : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        _mainCanvas.GetComponent<MessageNextController0>().enabled = false;
        _mainCanvas.GetComponent<MessageNextController1>().enabled = true;
    ...
    IEnumerator GoHomeCorutine()
    {
        ...
        _StartOut = true;
        _patientSpawnController.SpawnPatient(2);
    }
